    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="bg-gradient-to-br from-emerald-600 to-teal-600 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-1">Welcome back, Ahmed!</h2>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {/* Mobile Tabs */}
          <div className="lg:hidden bg-white rounded-xl shadow-md p-2 mb-4">
          ...
          <main className="flex-1">
            ...
            {activeTab === 'trips' && (
              <div>
                ...
                {/* Upcoming Trips */}
                <div className="mb-8">
                  <h4 className="text-xl font-semibold mb-4">Upcoming Trips</h4>
                  <div className="space-y-4">
                    {trips.filter(t => t.status === 'upcoming').map((trip) => (
                      <div key={trip.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all">
                            ...
                            <div className="flex flex-col h-full">
                              <div className="flex-1">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                  <UIBadge variant="secondary">Halal</UIBadge>
                                  <UIBadge variant="secondary">Prayer Room</UIBadge>
                                  <UIBadge variant="secondary">Family Friendly</UIBadge>
                                </div>
                              </div>

                              <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-neutral-200">
                                <Link href={`/package/${trip.id}`}>
                                  <Button size="sm">
                                    View Details
                                  </Button>
                                </Link>
                ...
                {/* Past Trips */}
                <div>
                  <h4 className="text-xl font-semibold mb-4">Past Trips</h4>
                  <div className="space-y-4">
                    {trips.filter(t => t.status === 'completed').map((trip) => (
                      <div key={trip.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all opacity-90">
                        <div className="flex flex-col md:flex-row">
                          <div className="relative md:w-64 h-48 md:h-auto flex-shrink-0">
                            <ImageWithFallback
                              src={trip.image}
                            ...
                            />
                            <div className="absolute top-4 left-4">
                              <UIBadge className="bg-neutral-600 text-white">
                                Completed
                              </UIBadge>
                            </div>
                          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {wishlistItems.map((item) => (
                    <div key={item.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all group">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="text-lg font-bold text-emerald-600">${item.price}</h4>
              ...
              <div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                  <div className="flex items-center gap-6 mb-8">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold mb-2">Ahmed Smith</h4>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  <h4 className="text-lg font-semibold mb-4">Travel Preferences</h4>
                  <div className="space-y-4">
