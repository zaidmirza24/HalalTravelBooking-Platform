              ...
              <div className="pt-2 space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1 flex-1">
                    ...
                    >
                      I agree to the{' '}
                      <Link href="/terms" className="text-emerald-600 hover:text-emerald-700 font-medium underline-offset-2 hover:underline">
                        Terms and Conditions
                      </Link>{' '}
                      and{' '}
                      <Link href="/privacy" className="text-emerald-600 hover:text-emerald-700 font-medium underline-offset-2 hover:underline">
                        Privacy Policy
                      </Link>
                    </label>
                    {errors.agreeToTerms && (
