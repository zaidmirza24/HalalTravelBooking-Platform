      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <Link href="/" className="text-neutral-700 hover:text-emerald-600 transition-colors">Home</Link>
            <Link href="/search" className="text-neutral-700 hover:text-emerald-600 transition-colors">Destinations</Link>
            <Link href="/search" className="text-neutral-700 hover:text-emerald-600 transition-colors">Packages</Link>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-t">
          <div className="container-custom py-4 flex flex-col gap-4">
            ...
            <Link href="/search" className="text-neutral-700 py-2">Destinations</Link>
            <Link href="/search" className="text-neutral-700 py-2">Packages</Link>
